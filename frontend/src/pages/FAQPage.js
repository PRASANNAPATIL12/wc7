...
const FAQPage = () => {
  ...
  return (
    <div 
      className="min-h-screen pt-16 pb-16 px-4 sm:px-6 md:px-8"
    ...
    >
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-12 sm:mb-16">
          <h1 
            className="text-4xl sm:text-5xl md:text-6xl font-light mb-4 sm:mb-6"
            style={{ 
          ...
          <div 
            className="w-20 sm:w-24 h-0.5 mx-auto mb-6 sm:mb-8"
          ...
          {isCustomFaqs ? (
            ...
            displayFaqs.map((faq) => {
              ...
              return (
                <div 
                  key={faq.id} 
                  className="bg-white/10 backdrop-blur-md rounded-3xl border border-white/20 overflow-hidden transition-all duration-300 hover:shadow-lg"
                  style={{
                ...
                >
                  ...
                  >
                    ...
                    <div className="flex-shrink-0">
                      {isOpen ? (
                        <ChevronUp className="w-5 h-5" style={{ color: theme.accent }} />
                      ) : (
        ...
        <div className="text-center mt-12 sm:mt-16">
          <div className="bg-white/10 backdrop-blur-md rounded-3xl p-6 sm:p-8 md:p-12 border border-white/20">
            <HelpCircle 
            ...
            <p 
              className="text-base sm:text-lg leading-relaxed mb-6 sm:mb-8 max-w-2xl mx-auto px-4"
              style={{ color: theme.textLight }}
            >
